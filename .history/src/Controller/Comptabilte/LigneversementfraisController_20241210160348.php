...
class LigneversementfraisController extends BaseController
{
 ...
 #[Route('/liste/paiement/{idR}', name: 'app_comptabilte_ligneversementfraiss_index', methods: ['GET', 'POST'])]
    ...
    public function new(Request $request, Compte $compte,Ligne,LigneversementfraisRepository $ligneversementfraisRepository,  EntityManagerInterface $entityManager, FormError $formError): Response
    {
