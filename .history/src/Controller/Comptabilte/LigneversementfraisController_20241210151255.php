            ...
            $table->add('id', TextColumn::class, [
                ...
                'render' => function ($value, Ligneversementfrais $context) use ($renders) {
                    $options = [
                        ...
                        'actions' => [
                            'edit' => [
                                'url' => $this->generateUrl('app_comptabilte_ligneversementfraiss_edit', ['id' => $value]),
                                'ajax' => true,
                                'icon' => '%icon% bi bi-pen',
...
/*************  ✨ Codeium Command ⭐  *************/
     ...
     * @param Ligneversementfrais $ligneversementfrai
     * @return Response
     */
/******  5b8e5465-22f9-4669-9480-c7675b7ceaf8  *******/
    ...
    #[Route('/{id}/edit', name: 'app_comptabilte_ligneversementfraiss_edit', methods: ['GET', 'POST'])]
