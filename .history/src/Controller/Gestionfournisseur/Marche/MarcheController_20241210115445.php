...
class MarcheController extends BaseController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        ...
        $table = $dataTableFactory->create()
            ->add('fournisseur', TextColumn::class, ['label' => 'Fournisseur','field' => 'f.libelle' ])
            ...
            ->add('montantpaye', TextColumn::class, ['label' => 'Total payé', "searchable" => false, 'render' => function ($value, Marche $context) {
                $montantpaye = str_replace( ',', '.', $context->getMontanttotal()) - str_replace( ',', '.', $context->getSolde());
                return (float0$montantpaye;
            }])
        ...
        if ($form->isSubmitted()) {
            ...
            if ($form->isValid()) {
               if ($marche->getMontanttotal() != null) {
                   $marche->setSolde((int)$marche->getMontanttotal());
                # code...
               }else{
