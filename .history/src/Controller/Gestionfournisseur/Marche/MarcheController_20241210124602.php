...
class MarcheController extends BaseController
{
    ...
    #[Route('/{id}/paiemnet', name: 'app_gestionfournisseur_marche_paiemnet', methods: ['GET', 'POST'])]
    public function doPaiement(Request $request, Marche $marche, EntityManagerInterface $entityManager, FormError $formError): Response
    {
        ...
        $form = $this->createForm(MarcheType::class, $marche, [
            'method' => 'POST',
            'action' => $this->generateUrl('app_gestionfournisseur_marche_paiemnet', [
                'id' => $marche->getId()
            ])
        ]);
        ...
        return $this->renderForm('gestionfournisseur/marche/paiemnet.html.twig', [
            'marche' => $marche,
            'form' => $form,
        ]);
    }
